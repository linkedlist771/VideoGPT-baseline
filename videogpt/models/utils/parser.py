...
def create_parser():
    ...
    parser.add_argument("--ex_name", "-ex", default="mfmnist_simvp_gsta", type=str)
    parser.add_argument(
        "--fp16",
        action="store_true",
        default=False,
    ...
    parser.add_argument(
        "--test", action="store_true", default=False, help="Only performs testing"
    )
    parser.add_argument(
        "--deterministic",
        action="store_true",
    ...
    # dataset parameters
    parser.add_argument(
        "--batch_size", "-b", default=16, type=int, help="Training batch size"
    )
    parser.add_argument(
        "--val_batch_size", "-vb", default=16, type=int, help="Validation batch size"
    )
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "weather",
            "weather_t2m_5_625",
            "weather_mv_4_28_s6_5_625",
            "weather_mv_4_4_s6_5_625",
            "weather_r_5_625",
            "weather_uv10_5_625",
            "weather_tcc_5_625",
            "weather_t2m_1_40625",
            "weather_r_1_40625",
            "weather_uv10_1_40625",
            "weather_tcc_1_40625",
            "sevir_vis",
            "sevir_ir069",
            "sevir_ir107",
    ...
    parser.add_argument(
        "--config_file",
        "-c",
        default="configs/mfmnist/simvp/SimVP_gSTA.py",
        type=str,
    ...
    parser.add_argument(
        "--epoch", "-e", default=None, type=int, help="end epochs (default: 200)"
    )
