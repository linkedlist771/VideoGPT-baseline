...
def create_parser():
    ...
    parser.add_argument('--dataname', '-d', default='mfmnist', type=str,
                        choices=['bair', 'mfmnist', 'mmnist', 'mmnist_cifar', 'noisymmnist', 'taxibj', 'human',
                                ...
                                'sevir_vis', 'sevir_ir069', 'sevir_ir107', 'sevir_vil', "deposition"],
    ...
    parser.add_argument('--config_file', '-c', default="configs/mfmnist/simvp/SimVP_gSTA.py", type=str,
