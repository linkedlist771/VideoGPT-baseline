...
def reserve_schedule_sampling_exp(itr, batch_size, args):
    ...
    r_random_flip = np.random.random_sample((batch_size, args.pre_seq_length - 1))
    r_true_token = r_random_flip < r_eta

    random_flip = np.random.random_sample((batch_size, args.aft_seq_length - 1))
