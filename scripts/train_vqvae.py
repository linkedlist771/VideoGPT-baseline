...
def main():
    ...
    parser.add_argument(
        "--n_codes", type=int, default=2048, help="Number of codes in codebook"
    )
    parser.add_argument(
        "--n_hiddens", type=int, default=240, help="Number of hidden units"
    )
    parser.add_argument(
        "--n_res_layers", type=int, default=4, help="Number of residual layers"
    )
    parser.add_argument(
        "--downsample",
        nargs="+",
